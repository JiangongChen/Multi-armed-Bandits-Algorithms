...
function all_regrets = Hedge(K,T,eta,miu,indicator)
    ...
    for k = 1:K % repeat experiment take average
        ...
        loss_vector = zeros(1,arm_num); % Initialize the losses
        ...
        for t = 1:T
            ...
            for i = 1:arm_num
                exp_ob(i) = (rand < miu(i));
                loss_vector(i) = loss_vector(i) + 1 - exp_ob(i); % Update the losses
            end
